...
public class metod {
    ...
    public static double tower_player(double x, double y, double rotation_tower, double speed_tower) {
        double mouse_x = ((MouseInfo.getPointerInfo().getLocation().getX()-18)*1.24)/ Game.zoom;
        double mouse_y = ((MouseInfo.getPointerInfo().getLocation().getY()-45)*1.24)/ Game.zoom;
        return tower(x, y, mouse_x, mouse_y, rotation_tower, speed_tower);
    }
