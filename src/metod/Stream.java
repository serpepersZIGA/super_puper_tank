...
public class Stream{
    public static void getInputStream(){
        try {
            ObjectInputStream input = new ObjectInputStream(Game.socket.getInputStream());
    ...
    public static void getOutputStream(){
        try {
            ObjectOutputStream output = new ObjectOutputStream(Game.socket.getOutputStream());
    ...
    public static void getInputStream_client(){
        try {
            ...
            Game.press_w_client = spisok_multiplayer.press_w;
            Game.press_a_client = spisok_multiplayer.press_a;
            Game.press_s_client = spisok_multiplayer.press_s;
            Game.press_d_client = spisok_multiplayer.press_d;
            Game.left_mouse_client = spisok_multiplayer.left_mouse;
            Game.right_mouse_client = spisok_multiplayer.right_mouse;
            Game.mouse_x_client = spisok_multiplayer.mx;
            Game.mouse_y_client = spisok_multiplayer.my;
    ...
    public static void getOutputStream_client(){
        try {
            ...
            //File file = new File("src/buffer.data");
            //FileOutputStream fos = new FileOutputStream(file);
            output.writeObject(new spisok_multiplayer_client(Game.press_w,Game.press_a,Game.press_s,Game.press_d,
