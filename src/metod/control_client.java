...
public class control_client implements KeyListener {
    ...
    public void iteration_control_client(){
        ...
        this.mouse_x = (((MouseInfo.getPointerInfo().getLocation().getX() - 18))*1.23)/ Game.zoom + Main.rc.get(0).x2;
        this.mouse_y = (((MouseInfo.getPointerInfo().getLocation().getY() - 45)*1.23))/ Game.zoom + Main.rc.get(0).y2;
