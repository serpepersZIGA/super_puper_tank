...
public class TowerBullTankEnemy extends Transport {
    public TowerBullTankEnemy(double x_const, double y_const, int difference, int difference_2, double reload_max, double speed_rotation, double damage, double penetration,
                              int ind_unit, byte height, byte team, Sprite tower_image, ArrayList<Transport> spisok, File sound){
